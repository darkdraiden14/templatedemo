...
import com.xiaopo.flying.sticker.richpath.pathparser.PathParser;
import com.xiaopo.flying.sticker.richpath.pathparser.PathParserCompat;
import com.xiaopo.flying.sticker.richpath.util.PathUtils;
...
public class RichPath extends Path {
    ...
    public void inflate(String pathData,String name, float fillAlpha, int fillColor,float strokeAlpha,int strokeColor,Paint.Cap strokeLineCap, Paint.Join strokeLineJoin,float strokeMiterLimit, float strokeWidth,float trimPathStart,float trimPathEnd,float trimPathOffset, Path.FillType fillType){
