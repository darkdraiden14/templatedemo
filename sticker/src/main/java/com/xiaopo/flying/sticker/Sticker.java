...
public abstract class Sticker {
  ...
  @IntDef(flag = true, value = {
          Position.CENTER, Position.TOP, Position.BOTTOM, Position.LEFT, Position.RIGHT, Position.MID_BOTTOM_CENTER,
  ...
  public  abstract void movedLeftHorizontally(float distance);
  ...
  public float getFWidth() { return -1;};

  public float getFHeight() {return -1;};

  public abstract void movedRightHorizontally(float distance);



  public  abstract void movedTopVertically(float distance);
  public  abstract void movedBottomVertically(float distance);
