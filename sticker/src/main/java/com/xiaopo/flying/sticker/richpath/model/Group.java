package com.xiaopo.flying.sticker.richpath.model;
...
public class Group {
    ...
    public Group(String name,float rotation,float pivotX,float pivotY,float scaleX,float scaleY,float translateX,float translateY){
    ...
    private void inflate(String name,float rotation,float pivotX,float pivotY,float scaleX,float scaleY,float translateX,float translateY){
        this.name = name;
