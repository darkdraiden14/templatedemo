...
public class RichPathDrawable extends Drawable {
    ...
    protected void onBoundsChange(Rect bounds) {
        ...
        Log.e("stickerT", "width"+width+"height"+height);
    ...
    @NonNull
    public List<RichPath> findAllRichPathsAsList() {
        if (vector == null) {
    ...
    public int getWidth(){//TODO merge in a new class
        return (int) vector.getWidth();
    }

    public int getHeight(){//TODO merge in a new class
        return (int) vector.getHeight();
    }
